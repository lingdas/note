...
tags: spring
keywords:  spring
description:  spring的快速入门 依赖注入
photos: https://cdn.jsdelivr.net/gh/lingdas/note/img/14.jpg
---
## 1. spring概述
...
### 1.4 Spring的体系结构（了解）
{% asset_img 图片29.png Spring的体系结构 %}
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="userDao" class="com.lovelves.UserDaoimpl"></bean>
</beans>
